...
import { FaGithub, FaBookmark, FaCalendarAlt, FaChartLine } from 'react-icons/fa';
                            ...
                            <div className="space-y-8">
                                {posts.map((post, index) => (
                                    <article
                                        ...
                                        style={{
                                            animationDelay: `${Math.min(index, 5) * 0.1}s`
                                        }}
                                    >
                                        <div className="p-6">
                                            <div className="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400 mb-3">
                                                {post.categories && (
                                                    <Link href={`/categories/${post.categories}`} className="inline-flex items-center gap-1 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-3 py-1.5 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-all duration-300 text-xs font-medium">
                                                        <FaBookmark size={10} />
                                                        {cap(post.categories!)}
                                                    </Link>
                                                )}
                                ...
                                <div className="text-center">
                                    <div className="relative inline-block mb-4">
                                        <Image
                                            ...
                                            width={80}
                                            height={80}
                                            className="rounded-full mx-auto border-4 border-gray-200 dark:border-gray-600 shadow-lg"
                                        />
                                        ...
                                        return Object.entries(tagMap)
                                            ...
                                            .map(([tag, count]) => (
                                                <Link
                                                    ...
                                                    className="inline-flex items-center gap-1 px-3 py-1 text-xs rounded-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-purple-100 dark:hover:bg-purple-900/40 hover:text-purple-700 dark:hover:text-purple-300 transition-all duration-200"
                                                >
                                                    #{cap(tag)}
